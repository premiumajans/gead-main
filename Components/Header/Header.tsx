    ...
    <>
      ...
      >
        <div className="header-body" style={{ top: "0px" }}>
          <div
            style={{ height: "100%" }}
            className="header-container custom-container"
          >
            <div className="header-row">
              <div className="header-column">
                <div className="header-row">
                  <div className="header-logo" style={{ height: "90%" }}>
                  ...
                  <div className="header-nav pt-1 firs-nav">
                    ...
                    >
                      ...
                      {show && settings?.length > 0 ? (
                        <ul className="header-social-icons social-icons gap-1 d-sm-flex">
                          <li
                          ...
                          >
                            <a
                              href={`${
                                settings?.find((el) => el.name == "twitter")
                                  ?.link
                              }`}
                              target="_blank"
                              title="twitter"
                          ...
                          >
                            <a
                              href={`${
                                settings?.find((el) => el.name == "youtube")
                                  ?.link
                              }`}
                              target="_blank"
                              title="youtube"
                          ...
                          >
                            <a
                              href={`${
                                settings?.find((el) => el.name == "linkedin")
                                  ?.link
                              }`}
                              target="_blank"
                              title="youtube"
