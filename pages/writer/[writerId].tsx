    ...
    <>
      <Head>
        <meta
          name="keywords"
          content={
            translations?.find((item) => item.locale === i18n.language)?.name
          }
        />
        <title>{translations ? translatedName + " | GEAD" : "GEAD"}</title>

        <meta
          property="og:title"
          content={translatedName ? translatedName + " | GEAD" : "GEAD"}
        />
        <meta
        ...
        <meta
          property="og:image"
          content={process.env.NEXT_PUBLIC_MAIN_PATH_WITHOUT_API! + photo}
        />
        <meta
          property="og:url"
          content={
          ...
          {typeof writers !== "string" ? (
            <>
                ...
                <div className="container">
                  <div className="row">
                    <div className="col-md-12 align-self-center p-static order-2 text-center">
                      <h1 className="text-dark font-weight-bold text-8">
                        {
                          translations?.find(
                            (item) => item.locale === i18n.language
                          )?.name
              ...
              <div className="post-meta mt-4">
                ...
                <span style={{ color: "#1d388c" }} className="mx-3">
                  <i className="far fa-calendar"></i>{" "}
                  <a>{transformDate(created_at)}</a>{" "}
                </span>
                <span>{view}</span>
              </div>
            </>
